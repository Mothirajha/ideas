...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'ideas.com'
  config.app_name = 'ideas'
  config.mailer.from = 'ideas <no-reply@ideas.com>'
  ...
  #
  config.app_secret = '0fMx3qNjZHg-kVbMuR3Q2otj-9d2sTKdKbr8k9KwOVXvEdr6A_17t7Kxyz7EI0nwI3Q'
